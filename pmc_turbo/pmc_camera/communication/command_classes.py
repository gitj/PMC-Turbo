...
import numpy as np
from pmc_turbo.pmc_camera.communication.packet_classes import GSECommandPacket

import pmc_turbo.pmc_camera.utils.comparisons
...
class Command(object):
    ...
    def encode_command(self,**kwargs):
        ...
        for argument_name in self._argument_names:
            ...
            if not pmc_turbo.pmc_camera.utils.comparisons.equal_or_close(value, formatted_value):
