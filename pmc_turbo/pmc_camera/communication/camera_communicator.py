...
from pmc_turbo.pmc_camera.communication import downlink_classes, uplink_classes, packet_classes
from pmc_turbo.pmc_camera.communication import file_format_classes
from pmc_turbo.pmc_camera.utils import error_counter

from pmc_turbo.pmc_camera.communication import command_table, command_classes
from pmc_turbo.pmc_camera.communication.command_table import command_manager, CommandStatus
...
class Communicator():
    ...
    ##################################################################################################
    # The following methods correspond to commands defined in pmc_turbo.pmc_camera.communication.command_table
