...
import numpy as np
from pmc_turbo.pmc_camera.communication.file_format_classes import decode_file_from_buffer, GeneralFile, JPEGFile, ShellCommandFile
from pmc_turbo.pmc_camera.pipeline import basic_pipeline
from pmc_turbo.pmc_camera.pipeline import controller

import pmc_turbo.pmc_camera.pipeline.indexer
...
class TestMultiIndex(object):
    ...
    def test_all_data(self):
        ...
        mi = pmc_turbo.pmc_camera.pipeline.indexer.MergedIndex(subdirectory_name=self.subdir, data_dirs=self.data_dirs)
