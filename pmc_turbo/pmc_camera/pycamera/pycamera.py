...
class PyCamera():
    def __init__(self,ip="10.0.0.2",num_buffers=0,use_simulated_camera=False):
        if use_simulated_camera:
            from pmc_turbo.pmc_camera.pycamera._pyvimba._pyvimba_simulator import BasicPyCameraSimulator as _PyCamera
        else:
            from pmc_turbo.pmc_camera.pycamera._pyvimba import PyCamera as _PyCamera
