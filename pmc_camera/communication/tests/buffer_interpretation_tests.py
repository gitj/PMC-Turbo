import unittest
from pmc_camera.communication import sip_buffer_receiving_methods, sip_buffer_receiving_methods
...
class BufferInterpretationTests(unittest.TestCase):
    ...
    def test_science_request(self):
        buffer = '\x10\x13\x03'
        packet, remainder = sip_buffer_receiving_methods.process_bytes(buffer)
